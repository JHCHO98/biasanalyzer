...
const defaultOptions = {
    ...
    colors: {
        ...
        leftCars: [0x7D0D31, 0xC9062D, 0xFF0000],
        rightCars: [0xF1F1F1, 0xFFFFFF, 0x090909],
        sticks: 0x03b3c3
    }
};
...
const Hyperspeed = ({
        ...
        class App {
            constructor(container, options = {}) {
                ...
                if (this.options.distortion == null) {
                    ...
                    // Ensure string distortion name maps to object if not already mapped by parent
                    // (Though the useEffect IIFE does mapping, checking here is safe)
                }
            ...
            update(delta) {
                if (this.mouseDown || loadingRef.current) {
    ...
    return (
        <div
            id="lights"
            ref={hyperspeed}
            className={`w-full h-full transition-all duration-700 ease-in-out ${isWarping || loading ? 'warp-effect' : ''}`}
