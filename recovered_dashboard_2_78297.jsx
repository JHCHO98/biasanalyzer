...
import {
  ...
  Scale, Compass, Sparkles, X, Filter, ExternalLink
} from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card 
          title="최근 시청 기록" 
          subtitle="각 항목을 누르면 정밀 모델 분석 리포트 확인 가능"
          ...
          <div className="space-y-6 mt-4">
            ...
            <div className="bg-zinc-50 dark:bg-zinc-950 p-6 rounded-xl border border-zinc-200 dark:border-white/5 space-y-5">
              ...
              <div className="bg-zinc-100 dark:bg-[#0A0A0A] rounded-xl border border-zinc-200 dark:border-white/5 p-4 space-y-3">
                <span className="text-[10px] font-mono text-zinc-550 uppercase tracking-widest block font-mono">실시간 시뮬레이션 추천 홈 피드</span>
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-500/5 border border-blue-500/10 rounded-xl p-5 flex flex-col justify-between space-y-4">
              ...
              <div className="pt-4 border-t border-blue-500/10 flex justify-between items-center text-[10px] font-mono text-zinc-550">
            ...
            <div className="bg-zinc-500/5 border border-zinc-500/20 dark:border-white/10 rounded-xl p-5 flex flex-col justify-between space-y-4">
              ...
              <div className="pt-4 border-t border-zinc-200 dark:border-white/5 flex justify-between items-center text-[10px] font-mono text-zinc-550">
            ...
            <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-5 flex flex-col justify-between space-y-4">
              ...
              <div className="pt-4 border-t border-red-500/10 flex justify-between items-center text-[10px] font-mono text-zinc-550">
...
export default function Dashboard({ presentationMode, rawLabels, youtubeApiKey: propApiKey }) {
  ...
  // Filtered videos for list modal
  const filteredVideos = useMemo(() => {
    const list = recentVideos || RECENT_VIDEOS;
  ...
  }, [recentVideos, searchQuery, filterBias]);
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <select
                    ...
                    className="bg-zinc-100 dark:bg-black/50 border border-zinc-200 dark:border-white/10 rounded-xl px-2.5 py-2 text-xs text-zinc-805 dark:text-zinc-100 focus:outline-none focus:border-indigo-500"
                  >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-6 border-b border-white/5 flex justify-between items-center bg-zinc-950">
                <div>
                  <h3 className="text-base font-bold text-zinc-100">전체 분석 비디오 데이터베이스</h3>
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg border text-xs font-bold transition-all ${
                        filterBias === b
                          ...
                          : 'bg-zinc-950 border-white/5 text-zinc-500 hover:text-zinc-350'
                      }`}
                    >
                      {b === 'all' && "전체"}
                      {b === 'progressive' && "진보"}
              ...
              <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b border-white/5 text-[10px] font-mono tracking-wider text-zinc-500 uppercase text-left">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-zinc-955 p-4 rounded-xl border border-white/5 flex justify-between items-center">
                  <div>
                  ...
                  <span className={`text-2xl font-black font-mono ${
                    selectedDetailVideo.biasScore > 0.05 ? 'text-rose-400' : selectedDetailVideo.biasScore < -0.05 ? 'text-blue-400' : 'text-zinc-300'
                  }`}>
                ...
                <div className="space-y-2">
                  <span className="text-[9px] font-mono text-zinc-500 uppercase block">어텐션 키워드 가중치 분석 (시뮬레이션)</span>
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border bg-zinc-950 border-white/5 text-xs text-zinc-300">
                        {kw.text}
